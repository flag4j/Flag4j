...
class MatrixMarketWriteTests {
    ...
    void writeRealDenseTestCase() throws IOException {
        ...
        // -------------------- sub-case 1  --------------------
        fileName = "./src/test/items/matrix_market/array/ReDe3x3_out.mtx";
        expData = new double[][] {
                {1, 2, 3},
        ...
        // -------------------- sub-case 2  --------------------
        fileName = "./src/test/items/matrix_market/array/ReDe5x2_out.mtx";
        expData = new double[][] {
        ...
        // -------------------- sub-case 3  --------------------
        fileName = "./src/test/items/matrix_market/array/ReDe7x14_out.mtx";
        expData = new double[][]{
    ...
    void writeRealCooTestCase() throws IOException {
        ...
        // ---------------- sub-case 1 ----------------
        fileName = "./src/test/items/matrix_market/coordinate/ReCoo5x5_8_out.mtx";
        exp = MatrixMarketMatrices.ReCoo5x5_8;
        MatrixMarketWriter.write(fileName, exp);
        assertEquals(exp, reader.read(fileName));

        // ---------------- sub-case 2 ----------------
        fileName = "./src/test/items/matrix_market/coordinate/jgl009_out.mtx";
        exp = MatrixMarketMatrices.jgl009;
        MatrixMarketWriter.write(fileName, exp);
        assertEquals(exp, reader.read(fileName));

        // ---------------- sub-case 3 ----------------
        fileName = "./src/test/items/matrix_market/coordinate/fidapm05_out.mtx";
    ...
    void writeCooSymmPatternTestCase() throws IOException {
        ...
        // ---------------- sub-case 1 ----------------
        fileName = "./src/test/items/matrix_market/coordinate/can___24_out.mtx";
